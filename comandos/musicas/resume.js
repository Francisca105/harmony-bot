...
exports.run = async (client, message, args, queue) => {
  ...
  if (serverQueue && !serverQueue.playing) {
    ...
    return message.channel.send(`${p} Continuando a música pausada para você!`);
  }
  return message.channel.send("Não há nada tocando para eu retomar!");
  ...
  function play(guild, song) {
    ...
    const dispatcher = serverQueue.connection.playStream(yt(song.url))
      .on('end', reason => {
        ...
        else console.log("RESUME " + reason);
